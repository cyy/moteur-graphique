...
<body class="login">
<?php   if ( !is_multisite() ) { ?>
<div id="login"><h1><a href="<?php echo esc_url( apply_filters('login_headerurl', home_url( '/' )) ); ?>" title="<?php echo esc_attr( apply_filters('login_headertitle', __( '' ) ) ); ?>"><?php bloginfo('name'); ?></a></h1>
<?php   } else { ?>
